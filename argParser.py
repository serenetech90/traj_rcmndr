...
class ArgsParser():
    ...
    parser.add_argument('--max_fr_size', type=int, default=100,
                        help='maximum number of pedestrians that can be found at one frame')
    ...
    parser.add_argument('--save_every', type=int, default=5, # 50,
                        help='save frequency')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.005, # 5e-3
                        help='learning rate')
    # Decay rate for the learning rate parameter
    parser.add_argument('--decay_rate', type=float, default=0.95,#new: 0.50
                        help='decay rate for rmsprop')
    # Dropout not implemented.
    # Dropout probability parameter
    parser.add_argument('--dropout', type=float, default=0.8, #new:0.08
    ...
    parser.add_argument('--maxNumPeds', type=int, default=10,
